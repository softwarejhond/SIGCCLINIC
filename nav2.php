        ...
        <ul class="nav-list">
            ...
            <li class="profile">
                ...
                <a href="https://agenciaeaglesoftware.com/" target="_blank">
                    <img src="images/LogoLetraBlanca.png" width="70px" alt="Eagle Software">
...
.sidebar {
    ...
    height: 100%;
    width: 78px;
    background-image:linear-gradient(rgba(24, 206, 231, 0.8), rgba(0, 118, 168,0.8)), url(images/fondo2.png);
    padding: 6px 14px;
    z-index: 99;
