...
// Include config file
  ...
  ?>
<nav class="navbar navbar-expand-lg navbar-dark sticky-top" style="background-image:linear-gradient(rgba(2, 52, 81, 0.8), rgba(0, 118, 168,0.8)), url(images/fondo2.png);">
