        ...
        <div class="card-img-overlay ">
            ...
            <?php
                               ...
                               while ($userLog = mysqli_fetch_array($query)) {
                                echo '<h6  class="card-text px-2 mt-1" style="color:#000;text-transform: uppercase;">'.$userLog['nombre'].' <div class="spinner-grow text-success" role="status"><span class="sr-only">Loading...</span></div></h6>';  
