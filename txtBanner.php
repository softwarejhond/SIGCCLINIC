        ...
        <div class="card-img-overlay ">
            ...
            <?php
                               ...
                               while ($userLog = mysqli_fetch_array($query)) {
                                echo '<h6  class="card-text px-2 mt-1" style="color:#000;text-transform: uppercase;">'.$userLog['nombre'].' <button class="btn btn-success" type="button" disabled><span class="spinner-grow spinner-grow-sm" role="status" aria-hidden="true"></span><span class="sr-only">Loading...</span> </button></h6>';  
