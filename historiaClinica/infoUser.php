    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 px-2 mt-1">
            ...
            <div class="form-group ">
                ...
                <input type="text" name="numeroIdentificacionAcudiente" placeholder="Número identificacion acudiente"
                    class="form-control"  value="<?php echo $row['numeroIdentificacionAcudiente']; ?>">
            </div>
            <div class="form-group ">
                ...
                <input type="text" name="telefonoAcudiente" placeholder="Teléfono acudiente" class="form-control"
                    value="<?php echo $row['telefonoAcudiente']; ?>">
            </div>
            <div class="form-group ">
